...
export default function UploadButton() {
  ...
  return (
    <div>
      <label
        htmlFor="avatarInput"
        className="group flex items-center justify-start w-8 h-8 bg-[#242526] rounded-full cursor-pointer relative overflow-hidden transition-all duration-200 shadow-lg hover:w-32 hover:rounded-lg active:translate-x-1 active:translate-y-1"
      >
